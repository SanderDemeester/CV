...
\moveleft.5\hoffset\centerline{8310 Brugge, Sint-kruis}
\moveleft.5\hoffset\centerline{0476 86 48 84}
...
Mijn laatste jaar in het middelbaar liep ik stage voor administratief medewerker. Deze stage is ge\"evolueerd naar ICT werk en programmeren toen bleek dat ik een meerwaarde kon zijn bij de ICT dienst. Het resultaat was een security model met een advies over het WiFi Security Model(802.11i).
